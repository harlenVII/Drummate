        ...
        <div className={`${activeTab === 'practice' ? 'max-w-4xl' : 'max-w-lg'} mx-auto px-4 py-8 flex flex-col gap-6`}>
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-violet-600 flex items-center justify-center text-white text-sm font-semibold hover:bg-violet-700 transition-colors shrink-0"
