...
function FloatingPracticeWidget({ itemName, elapsedTime, onStop, onNavigate }) {
  ...
  return (
    <button
      ...
      className={`fixed ${pos ? '' : 'top-4 left-1/2 -translate-x-1/2'} z-50 h-9 flex items-center gap-3 pl-4 pr-2 rounded-full bg-accent-600 text-white shadow-lg max-w-[280px] hover:bg-accent-700 cursor-grab active:cursor-grabbing select-none`}
      aria-label={itemName}
    >
