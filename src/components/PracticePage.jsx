...
function PracticeRow({ practice, isFocused, onStart, onEdit }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onStart}
        className="px-3 py-1.5 rounded-md text-sm bg-indigo-600 text-white font-medium hover:bg-indigo-700"
      >
    ...
    <>
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="self-end px-4 py-2 rounded-full bg-indigo-600 text-white font-medium hover:bg-indigo-700"
        >
