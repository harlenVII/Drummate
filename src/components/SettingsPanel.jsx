            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${
                  aiCoachEnabled ? 'bg-violet-600' : 'bg-gray-300 dark:bg-slate-600'
                } cursor-pointer`}
                role="switch"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${
                  kokoroEffective ? 'bg-violet-600' : 'bg-gray-300 dark:bg-slate-600'
            ...
            {kokoroStatus === 'downloading' && (
              <div className="flex flex-col gap-1">
                <p className="text-xs text-violet-500">{t('naturalVoice.downloading')}</p>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${
                  handsFreeMode ? 'bg-violet-600' : 'bg-gray-300 dark:bg-slate-600'
            ...
            {!isChrome ? (
              ...
              <>
                {wakeWordLoading && (
                  <p className="text-xs text-violet-500">{t('handsFree.loading')}</p>
                )}
                ...
                {listeningState === 'processing' && voiceTranscript && (
                  <p className="text-xs text-violet-600 font-medium">&ldquo;{voiceTranscript}&rdquo;</p>
                )}
