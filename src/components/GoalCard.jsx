      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4 flex flex-col gap-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-3">
            <button onClick={() => setShowModal(true)} className="text-xs text-blue-600 dark:text-indigo-600 hover:underline">
              {t('goal.editGoal')}
            </button>
        ...
        <div className="w-full bg-gray-100 dark:bg-slate-700 rounded-full h-2">
          <div
            className={`h-2 rounded-full transition-all ${goalMet ? 'bg-green-500' : 'bg-blue-500 dark:bg-indigo-500'}`}
