...
function EncouragementButton({ status, onPress }) {
  ...
  return (
    <button
      onClick={onPress}
      className="fixed bottom-20 right-4 z-40 w-14 h-14 rounded-full bg-accent-600 hover:bg-accent-700 flex items-center justify-center text-white shadow-lg transition-all duration-200 active:scale-95"
