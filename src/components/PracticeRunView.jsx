    ...
    <div className="flex flex-col gap-6 items-center">
      ...
      {isCountingIn ? (
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-7xl font-bold text-indigo-600 tabular-nums">
            {countInBarsLeft}
          </div>
        </div>
      ) : (
        <>
          ...
          <div className="w-full max-w-sm flex flex-col gap-1">
            <div className="flex justify-end">
              <span className="text-sm font-semibold text-indigo-600">{Math.round(progressPct)}%</span>
            </div>
      ...
      {complete ? (
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-6 py-2 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700 min-w-[100px]"
          >
