...
| `U` | Toggle time unit between minutes and hours |
| `L` | Toggle language between English and Chinese |
| `T` | Toggle theme between Light and Dark |
| `C` | Cycle accent color (`blue` → `orange` → `green`, order from `ACCENTS`) |
